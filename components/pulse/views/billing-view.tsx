...
export function BillingView({ onBack }: BillingViewProps) {
  ...
  const currentTierIndex = getTierIndex(streak);
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4 max-w-2xl mx-auto w-full">
        ...
        <div className="rounded-3xl p-5 border-2 border-[#84CC16]" style={{ background: '#84CC1608' }}>
          ...
          <div className="mt-4 pt-3 border-t border-border">
            <p className="text-xs text-muted-foreground">Streak: <span className="text-foreground font-semibold">{streak} days</span> · Consistency: <span className="text-foreground font-semibold">5/7 days/week</span></p>
          </div>
        </div>
